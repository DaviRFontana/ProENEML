...
Este repositório ainda não possui um passo-a-passo consolidado de execução. Quando o fluxo estiver fechado, documentar aqui:

- **requisitos** (ex.: Node, banco, variáveis de ambiente)
- **instalação**
- **como rodar o front/back**

## Estrutura (visão rápida)

- `front/`: front-end (arquivos estáticos em `public/`)
